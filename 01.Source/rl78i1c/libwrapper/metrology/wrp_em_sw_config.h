...
*******************************************************************************/
    ...
    ***************************************************************************/
    #define EM_SW_PROPERTY_ADC_GAIN_NUMBER_LEVEL                1           /* (SW Support Only) - Number of gain   */
    
    #define EM_SW_PROPERTY_ADC_GAIN_PHASE_UPPER_THRESHOLD       970000     /* (SW Support Only) - 2^22 (22 bits reg)     */
    #define EM_SW_PROPERTY_ADC_GAIN_PHASE_LOWER_THRESHOLD       61000      /* (SW Support Only) - 2^14 (14 bits reg)     */
    
    #define EM_SW_PROPERTY_ADC_GAIN_NEUTRAL_UPPER_THRESHOLD     1900000     /* (SW Support Only) - 2^22 (22 bits reg)     */
    #define EM_SW_PROPERTY_ADC_GAIN_NEUTRAL_LOWER_THRESHOLD     120000      /* (SW Support Only) - 2^14 (14 bits reg)     */
    ...
    /* Individual gain number setting for Phase and Neutral channel */
    ...
    ***************************************************************************/
    /* I/Fs Mapping 
     *      Macro Name / I/Fs                                   Setting/Description */
    #define EM_PULSE_ACTIVE_ON_STATEMENT                              {SET_BIT(P0,2,0);}              /* Pulse 0 LED On *///PORTING
    #define EM_PULSE_ACTIVE_OFF_STATEMENT                             {SET_BIT(P0,2,1);}              /* Pulse 0 LED Off */
        ...
        #define EM_PULSE_REACTIVE_ON_STATEMENT                     {SET_BIT(P5,4,0);}                          //  {SET_BIT(P4,2,0);}        /* Pulse 1 LED On */
        #define EM_PULSE_REACTIVE_OFF_STATEMENT                     {SET_BIT(P5,4,1);}                         //  {SET_BIT(P4,2,1);}        /* Pulse 1 LED Off */
        ...
        #define EM_PULSE_APPARENT_ON_STATEMENT                        {SET_BIT(P4,2,0);}        /* Pulse 2 LED On */
        #define EM_PULSE_APPARENT_OFF_STATEMENT                       {SET_BIT(P4,2,1);}        /* Pulse 2 LED Off */
    ...
    ***************************************************************************/    
    ...
    #define EM_ADC_CURRENT_DRIVER_CHANNEL_OPTIMIZATION_VOLTAGE  0                               /* Match this with definitions above */
    #define EM_ADC_CURRENT_DRIVER_CHANNEL_OPTIMIZATION_PHASE    1                               /* Match this with definitions above */
    #define EM_ADC_CURRENT_DRIVER_CHANNEL_OPTIMIZATION_NEUTRAL  2                               /* Match this with definitions above */
    ...
    #define EM_ADC_GAIN_PHASE_LEVEL0                            (GAIN_X8)                       /* AD Gain Phase Level 0 (lowest) */
    #define EM_ADC_GAIN_PHASE_LEVEL1                            (GAIN_X32)                       /* AD Gain Phase Level 1 */
    /* Neutral Gain Specification */
    #define EM_ADC_GAIN_NEUTRAL_LEVEL0                          (GAIN_X1 )                     /* AD Gain Neutral Level 0 (lowest) */
    #define EM_ADC_GAIN_NEUTRAL_LEVEL1                          (GAIN_X4 )                     /* AD Gain Neutral Level 1 */
    ...
    #define EM_ADC_DriverStart()                                R_DSADC_Start()                         /* AD Driver Start                  */
    #define EM_ADC_DriverStop()                                 R_DSADC_Stop()                          /* AD Driver Stop                   */
