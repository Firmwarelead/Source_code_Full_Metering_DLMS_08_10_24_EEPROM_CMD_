...
#define EPR_BUS_SPEED                       400000                  /* Max I2C Bus speed (Hz) */
#define EPR_DEVICE_START_ADDR               0x0000                  /* EEPROM device start address */
#define EPR_DEVICE_SIZE                     0x20000                 /* EEPROM device size (1 Mb EEPROM size) */
#define EPR_DEVICE_PAGESIZE                 0x100                    /* 256 bytes/page */
#define EPR_DEVICE_WRITE_CYCLE_TIME         (5000)                  /* Spec is 5ms */
#define EPR_WRITE_PROTECT_DISABLE_STATEMENT {SET_BIT(P6,2,0);}      /* Command or interface to disable write protection, IICA board on EVB not have WP */
#define EPR_WRITE_PROTECT_ENABLE_STATEMENT  {SET_BIT(P6,2,1);}      /* Command or interface to enable write protection, IICA board on EVB not have WP */
/*
...
void EEPROM_Erase(uint32_t address, uint32_t size) ;            /* EEPROM Erase */
void EEPROM_Erase_All(void);                                    /* EEPROM Erase all */
