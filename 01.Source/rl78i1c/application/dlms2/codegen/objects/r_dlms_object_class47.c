...
/******************************************************************************	
* File Name    : r_dlms_object_class47.c
* Version      : 2.00
...
/*---------------------------------------------------------------------------*/
/*Class 47 record table*/
/*---------------------------------------------------------------------------*/
const class47_child_record_t	g_objects_child_table_class47[] =
{
	/* 00 - GSM Diagnostic */
	{ 
		{0,   0,   25,   6,   0,   255},
...
const uint16_t 	g_objects_child_table_class47_length = sizeof(g_objects_child_table_class47) / sizeof(class47_child_record_t);



/******************************************************************************
* Function Name : R_DLMS_OBJECTS_Class47Distributor
* Interface     : void R_DLMS_OBJECTS_Class47Distributor(
*               :     distributor_params_t * p_param,
*               : );
* Description   : User distributor function for GET/SET/ACTION service of class 47
* Arguments     : distributor_params_t * p_param: Distribution params from library
* Return Value  : None
******************************************************************************/
void R_DLMS_OBJECTS_Class47Distributor(distributor_params_t *p_params)
{
			...
			case 2:
				if (p_params->distributor_state == DIST_BEFORE_CLASS_FUNCTION)
				{
					...
					switch(p_params->child_index)
					{
						case 0:
							/* Clone new attribute */
							R_DLMS_IC47_REDIRECT_02(p_params, p_class47_obj->p_operator, r_dlms_ic47_obj00_att02_Operator_string_length);
							/* APPLICATION */
							result = R_DLMS_USER_ic47_obj00_att02_get(p_params, p_class47_obj->p_operator);
							break;
			...
			case 3:
				if (p_params->distributor_state == DIST_BEFORE_CLASS_FUNCTION)
				{
					...
					switch(p_params->child_index)
					{
						case 0:
							/* Clone new attribute */
							R_DLMS_IC47_REDIRECT_03(p_params, p_class47_obj->p_status);
							/* APPLICATION */
							result = R_DLMS_USER_ic47_obj00_att03_get(p_params, p_class47_obj->p_status);
							break;
			...
			case 4:
				if (p_params->distributor_state == DIST_BEFORE_CLASS_FUNCTION)
				{
					...
					switch(p_params->child_index)
					{
						case 0:
							/* Clone new attribute */
							R_DLMS_IC47_REDIRECT_04(p_params, p_class47_obj->p_cs_attachment);
							/* APPLICATION */
							result = R_DLMS_USER_ic47_obj00_att04_get(p_params, p_class47_obj->p_cs_attachment);
							break;
			...
			case 5:
				if (p_params->distributor_state == DIST_BEFORE_CLASS_FUNCTION)
				{
					...
					switch(p_params->child_index)
					{
						case 0:
							/* Clone new attribute */
							R_DLMS_IC47_REDIRECT_05(p_params, p_class47_obj->p_ps_status);
							/* APPLICATION */
							result = R_DLMS_USER_ic47_obj00_att05_get(p_params, p_class47_obj->p_ps_status);
							break;
			...
			case 6:
				if (p_params->distributor_state == DIST_BEFORE_CLASS_FUNCTION)
				{
					...
					switch(p_params->child_index)
					{
						case 0:
							/* Clone new attribute */
							R_DLMS_IC47_REDIRECT_06(p_params, p_class47_obj->p_cell_info);
							/* APPLICATION */
							result = R_DLMS_USER_ic47_obj00_att06_get(p_params, p_class47_obj->p_cell_info);
							break;
			...
			case 7:
				if (p_params->distributor_state == DIST_BEFORE_CLASS_FUNCTION)
				{
					...
					switch(p_params->child_index)
					{
						case 0:
							/* Clone new attribute */
							R_DLMS_IC47_REDIRECT_07(p_params, p_class47_obj->p_adjacent_cells, r_dlms_ic47_obj00_att07_array_length);
							/* APPLICATION */
							result = R_DLMS_USER_ic47_obj00_att07_get(p_params, p_class47_obj->p_adjacent_cells);
							break;
			...
			case 8:
				if (p_params->distributor_state == DIST_BEFORE_CLASS_FUNCTION)
				{
					...
					switch(p_params->child_index)
					{
						case 0:
							/* Clone new attribute */
							R_DLMS_IC47_REDIRECT_08(p_params, p_class47_obj->p_capture_time);
							/* APPLICATION */
							result = R_DLMS_USER_ic47_obj00_att08_get(p_params, p_class47_obj->p_capture_time);
							break;
