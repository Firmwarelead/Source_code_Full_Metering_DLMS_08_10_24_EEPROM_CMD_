...
void R_IICA0_Create(void)
{
    ...
    IICWL0 = _08_IICA_LOW_WIDTH;
    IICWH0 = _08_IICA_HIGH_WIDTH;
    DFC0 = 1U;      /* digital filter off */
    IICCTL01 &= (uint8_t)~_01_IICA_FCLK_2_SELECTED;
...
/***********************************************************************************************************************
* Function Name: R_IICA0_Start
* Description  : This function starts IICA0 module operation.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
void R_IICA0_Start(void)
{
    LREL0 = 1U;     /* exit current communication */
    IICE0 = 1U;     /* enable IICA0 operation */
    STCEN0 = 1U;    /* enable start condition without stop detection */
}
...
void R_IICA0_SetTransClockAt24MHz(void)
{
    ...
    IICWH0 = _0F_IICA_HIGH_WIDTH;
    DFC0 = 1U; /* digital filter off */
    IICCTL01 |= _01_IICA_FCLK_2_SELECTED;
}
/* End user code. Do not edit comment generated here */
