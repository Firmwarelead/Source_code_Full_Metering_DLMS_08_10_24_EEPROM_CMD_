...
***********************************************************************************************************************/
#ifdef __CCRL__
#pragma interrupt r_uart0_interrupt_receive
#endif /* __CCRL__ */
#ifdef __ICCRL78__
__interrupt
#endif /* __ICCRL78__ */
...
***********************************************************************************************************************/
#ifdef __CCRL__
#pragma interrupt r_uart0_interrupt_send
#endif /* __CCRL__ */
#ifdef __ICCRL78__
__interrupt
#endif /* __ICCRL78__ */
...
void r_uart2_interrupt_receive(void)
{
    ...
    rx_data = RXD2;
    g_uart2_rx_buff[rx]=rx_data; //need to add after every code generate
    rx++;                      //need to add after every code generate
    UART2_Ideal_Timer=0;        //need to add after every code generate
...
***********************************************************************************************************************/
#ifdef __CCRL__
#pragma interrupt r_csi30_interrupt
#endif /* __CCRL__ */
#ifdef __ICCRL78__
__interrupt
#endif /* __ICCRL78__ */
