...
void R_DSADC_Create(void)
{
    ...
    DSADCEN = 0U;   /* disable input clock supply */
    ...
    DSADHPFCR = _80_DSAD_CUTOFF_FREQUENCY_2 | _00_DSAD_CH2_HIGHPASS_FILTER_ENABLE | 
...
void R_DSADC_Start(void)
{
    ...
    MCU_Delay(2);
    DSADMR |= _0707_DSAD_ENABLE_3CH;        /* Start conversion ADC channel 01-3 */
...
{
    DSADMR |= _0400_DSAD_CH2_POWER_ON | _0200_DSAD_CH1_POWER_ON | _0100_DSAD_CH0_POWER_ON;
    MCU_Delay(2);
}
/***********************************************************************************************************************
...
{
    DSADMR &= (uint16_t)~(_0400_DSAD_CH2_POWER_ON | _0200_DSAD_CH1_POWER_ON | _0100_DSAD_CH0_POWER_ON);
    MCU_Delay(2);
}
/***********************************************************************************************************************
