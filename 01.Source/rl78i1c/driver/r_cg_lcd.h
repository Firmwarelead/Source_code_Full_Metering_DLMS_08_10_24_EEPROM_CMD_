...
Macro definitions
***********************************************************************************************************************/
#define LCD_REFVOLTAGE_WAITTIME             (7500U) /* wait for the reference voltage setup time (5 ms (min.)) */
#define LCD_VOLTAGE_WAITTIME                (400U) /* voltage boost wait time (500 ms) */
